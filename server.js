...
app.get('/create-canvas', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'create-canvas.html'));
});
app.get('/profile', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'profile.html'));
});
app.get('/create-assistant', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'create-assistant.html'));
});
app.get('/story', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'story.html'));
});
...
app.get('/test-auth', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'test-auth.html'));
});
app.get('/simple-test', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'simple-test.html'));
});
app.get('/test-page', (_req, res) => {
    res.sendFile(path.join(frontendDir, 'test-page.html'));
});
